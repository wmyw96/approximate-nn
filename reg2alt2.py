...
def build_model(num_hidden, decay, activation):
    ...
    # resample loss
    resample_theta1_loss = layer2_l2_loss * 10.0 + regs[0] + regs[1]
    ...
    resample_theta1_grads = tf_add_grad_noise(resample_theta1_grads, 3e-2, 1e-4 * lr_decay)
...
if True:
    ...
    candidate_mode = ['lst', 'resample_theta2', 'resample_theta1']#, 'lst', 'lst', 'resample_theta2', 'resample_theta1',
