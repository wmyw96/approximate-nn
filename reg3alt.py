...
def build_model(num_hidden, decay, activation):
    ...
    # resample loss
    resample_theta1_loss = layer2_l2_loss + regs[0] + regs[1]
    resample_theta2_loss = layer3_l2_loss + regs[1] + regs[2]
...
if True:
    ...
    candidate_mode = ['lst', 'resample_theta1', 'resample_theta2']
    # reinit
